...
_OPERATION_OVERRIDES: dict[tuple[str, str], dict[str, str]] = {
    (
        ...
        "description": (
            ...
            "This endpoint forwards the payload to AMP-HITL for WHEN/WHO/WHAT/WHERE "
            "evaluation. It may return immediately with no HITL needed, or accept the "
            "request and complete later via human or auto routing.\n\n"
            "Request JSON (common fields):\n"
            "{\n"
            "  \"caller_id\": \"<instance-or-activity-id>\",\n"
            "  \"instance_id\": \"<optional alias of caller_id>\",\n"
            "  \"org_id\": \"<optional>\",\n"
            "  \"agent_name\": \"<optional>\",\n"
            "  \"hitl\": {\n"
            "    \"enable\": true,\n"
            ...
            "  \"caller_id\": \"<id>\",\n"
            "  \"status\": \"complete\",\n"
            "  \"resolution\": \"approve|reject|modify|defer|unknown\",\n"
            "  \"method\": \"human|auto\",\n"
            "  \"workitem_id\": \"<id_or_empty>\",\n"
            "  \"information\": \"<optional detail>\",\n"
            "  \"event_ts\": \"<ISO-8601 UTC timestamp>\"\n"
            "}"
        ),
    },
}
